                    ...
                    if (fetchEmissionMaterialFactorSupResult.rows[0]) {
                        ...
                        if (fetchQ13SupResult.rows[0]) {
                            ...
                            if (locationLower === "india") {
                                Material_Emission_Factor_kg_CO2E_kg = parseFloat(String(fetchEmissionMaterialFactorSupResult.rows[0].ef_india_region || '').replace(/,/g, '')) || 0.01;
                                console.log("Using India emission factor:", Material_Emission_Factor_kg_CO2E_kg);
                            } else if (locationLower === "europe") {
                                Material_Emission_Factor_kg_CO2E_kg = parseFloat(String(fetchEmissionMaterialFactorSupResult.rows[0].ef_eu_region || '').replace(/,/g, '')) || 0.01;
                                ...
                                Material_Emission_Factor_kg_CO2E_kg = parseFloat(String(fetchEmissionMaterialFactorSupResult.rows[0].ef_global_region || '').replace(/,/g, '')) || 0.01;
