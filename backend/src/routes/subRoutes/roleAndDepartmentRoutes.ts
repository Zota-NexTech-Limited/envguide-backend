...
roleAndDeptRoutes.get('/api/get-department-list', roleAndDeptController.getDepartmentList)
...
roleAndDeptRoutes.get('/api/get-role-list', roleAndDeptController.getRoleList)
